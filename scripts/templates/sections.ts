...
/* buttons */
/* Sized for a real control, not a hero slab: 44px tall meets the minimum
   touch target without the chunky look of the previous 14/28 padding. */
.btn{display:inline-flex;align-items:center;justify-content:center;gap:8px;min-height:44px;padding:11px 22px;border-radius:${btnRadius};font-weight:600;font-size:.92rem;line-height:1.2;border:1px solid transparent;transition:transform .18s cubic-bezier(.16,1,.3,1),background .18s,border-color .18s,opacity .18s,box-shadow .18s;cursor:pointer;font-family:inherit;text-decoration:none}
