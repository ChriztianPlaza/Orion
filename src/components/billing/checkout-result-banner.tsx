...
export function CheckoutResultBanner() {
  ...
  return (
    <div className="mb-6 flex items-start gap-3 rounded-[16px] border border-[#30d158]/25 bg-[#30d158]/[0.06] px-4 py-3.5">
      ...
      <div className="flex-1">
        ...
        <p className="mt-1 text-[13px] text-white/50">
          {active
            ? "Unlimited websites, unlimited downloads and one-click deployment are unlocked."
